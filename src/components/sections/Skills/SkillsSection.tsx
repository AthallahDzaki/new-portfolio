...
export function SkillsSection({
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
        <div>
          ...
          <p className="text-white/60 text-sm sm:text-base font-light max-w-xl mt-3">
            An interconnected topology of technical competencies across Creative 3D, Frontend Core, Fullstack Systems, and Tools. Drag to rotate in 3D or click any node to inspect details.
          </p>
        </div>
      ...
      {/* Main Viewport */}
      {viewMode === "graph" ? (
        <div className="relative w-full h-[460px] sm:h-[520px] md:h-[580px] bg-[#070709] border border-white/15 overflow-hidden shadow-2xl flex flex-col justify-between p-4 group">
          {/* Top HUD bar */}
          <div className="w-full flex items-center justify-between font-mono text-[11px] text-white/50 border-b border-white/10 pb-3 z-10 pointer-events-none select-none">
